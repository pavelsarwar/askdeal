  ...
  <form id="offerForm" onsubmit="saveOffer(event)" class="offer-editor-layout">
    ...
    <aside class="offer-side">
      ...
      <div class="card" style="padding:16px;margin-top:14px"><h3 style="margin-top:0">Offer Settings</h3>
        ...
        <div class="field"><label>Offer Type</label><select id="offerType"><option value="sale" ${selected(record?.offer_type,'sale')}>Sale / Offer</option><option value="clearance" ${selected(record?.offer_type,'clearance')}>Warehouse / Clearance</option><option value="promotion" ${selected(record?.offer_type,'promotion')}>Promotion</option><option value="freebie" ${selected(record?.offer_type,'freebie')}>Freebie</option></select></div>
