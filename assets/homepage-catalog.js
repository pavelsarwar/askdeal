(async function(){
  const catHost=document.getElementById('dynamicCategoryList'),offerHost=document.getElementById('homeAvailableOffers'),countHost=document.getElementById('homeOfferCount');
