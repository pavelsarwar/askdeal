const CACHE='naps-pwa-v1';
const CORE=['./','./index.html','./deals.html','./compare.html','./categories.html','./offline.html','./assets/style.css','./assets/app.js','./assets/naps-icon.svg','./manifest.webmanifest'];
